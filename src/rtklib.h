...
#define IONOOPT_IFLC 3 /* ionosphere option: L1/L2 iono-free LC 双频无电离层组合*/
#define IONOOPT_EST 4  /* ionosphere option: estimation 电离层参数估计*/
...
#define TROPOPT_EST 3  /* troposphere option: ZTD estimation 对流层参数估计 */
#define TROPOPT_ESTG 4 /* troposphere option: ZTD+grad estimation 对流层参数估计 */
...
#define FILEPATHSEP '/'
    ...
    typedef struct
    {                                                            /* time struct */
        time_t time; /* time (s) expressed by standard time_t */ // 秒整数
        double sec; /* fraction of second under 1 s */           // 秒内小数
    } gtime_t;
    ...
    /* myself standard positioning ------------------------------------------------------*/
    EXPORT extern int my_pntpos(const obsd_t *obs, int n, const nav_t *nav,
    ...
    /* precise point positioning -------------------------------------------------*/
    EXPORT void my_pppos(rtk_t *rtk, const obsd_t *obs, int n, const nav_t *nav, double *rs, int *exc);
